      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button onClick={onOpenAuth} className="text-gray-400 hover:text-white transition">
              Login
            </button>
            <button
              onClick={onOpenAuth}
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-white/5">
            <div className="flex flex-col gap-4">
              ...
              <button onClick={onOpenAuth} className="bg-orange-600 text-white px-6 py-2.5 rounded-lg font-semibold text-left">
                Start Free Trial
              </button>
            </div>
          </div>
